    ...
    >
      ...
      {gameState === 'OUROBOROS' && (
        ...
        >
          ...
          <svg className="ouroboros-spin" width="100" height="100" viewBox="0 0 100 100">
            <defs>
            ...
            <circle
              ...
              strokeLinecap="round"
            />
            {/* Eye of the biting snake */}
            <circle cx="50" cy="14" r="1.5" fill="#ffffff" />
            <circle cx="50" cy="14" r="3" fill="none" stroke="red" strokeWidth="0.5" />
          </svg>
